 ...
 * @author alfathrev
 */
public class dashboardcadangan extends javax.swing.JFrame {

    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(dashboardcadangan.class.getName());

    private final com.mycompany.transylvaniahotel.dao.BaseDAO<com.mycompany.transylvaniahotel.model.Karyawan> karyawanDAO;

    public dashboardcadangan() {
    ...
    private void loadDataKaryawan(String keyword) {
        // 1. Bersihkan kontainer dari kartu-kartu sisa sebelumnya
        ...
        // 3. Lakukan perulangan (loop), buat kartu baru untuk tiap data karyawan, lalu tempel
        for (com.mycompany.transylvaniahotel.model.Karyawan k : listKaryawan) {
            CardKaryawan card = new CardKaryawan(k, this);

            // Kunci ukuran kartu agar GridLayout di containerKaryawan rapi
            card.setPreferredSize(new java.awt.Dimension(256, 128));
            card.setMinimumSize(new java.awt.Dimension(256, 128));
            card.setMaximumSize(new java.awt.Dimension(256, 128));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new dashboardcadangan().setVisible(true));
    }
